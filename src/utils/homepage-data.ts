import type { AwardCategory, NavLink } from "@/types/homepage";
...
export const AWARD_CATEGORIES: AwardCategory[] = [
	...
	},
	{
		...
		thumbnailPath: "/images/homepage/awards/top-project.png",
	},
	{
		name: "Top Project Leader",
		slug: "top-project-leader",
		description:
			"Vinh danh những người dẫn dắt dự án xuất sắc, truyền cảm hứng và tạo nên thành công.",
		thumbnailPath: "/images/homepage/awards/top-project-leader.png",
	},
	{
		name: "Best Manager",
		slug: "best-manager",
		description:
			"Giải thưởng dành cho những nhà quản lý xuất sắc, xây dựng đội ngũ mạnh mẽ.",
		thumbnailPath: "/images/homepage/awards/best-manager.png",
	},
	{
		name: "Signature 2025 - Creator",
		slug: "signature-2025-creator",
		description:
			"Giải thưởng đặc biệt năm 2025, vinh danh những người sáng tạo đột phá.",
		thumbnailPath: "/images/homepage/awards/signature-2025-creator.png",
	},
	{
		name: "MVP",
		slug: "mvp",
		...
		thumbnailPath: "/images/homepage/awards/mvp.png",
	},
];
...
export const EVENT_LOCATION = "Âu Cơ Art Center";
export const EVENT_NOTE = "Tường thuật trực tiếp qua sóng Livestream";

export const ROOT_FURTHER_CONTENT = {
	paragraphs: [
	...
	quoteTranslation: "(Cây sâu bén rễ, bão giông chẳng nề - Ngạn ngữ Anh)",
	closingParagraphs: [
...
export const KUDOS_CONTENT = {
	...
	title: "Sun* Kudos",
	subLabel: "ĐIỂM MỚI CỦA SAA 2025",
	description:
